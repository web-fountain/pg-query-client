// AIDEV-NOTE: Centralized types for QueryTree. Encodes item payloads, tree item API shape,
...
// AIDEV-NOTE: Subset of Headless Tree item API that QueryTree uses. Keeps view components type-safe
